...
スクリプトを扱うことでより自由度の高いコンテンツをつくることができますが、ゼロからスクリプトを書いていくのは大変な作業です。
誰もが最初はどこかの誰かが書いたスクリプトを参考にしたりするでしょう。
...
他のアイテムからメッセージを受け取った時に実行される処理を各場所です。
...
下記は私が公開している Unity プロジェクトで用いているスクリプトの一部で、人狼ゲームの準備をするために人狼と村人を振り分ける処理をしているものです。

このスクリプトは下記からも参照できます。
https://github.com/dolow/ItemVisibilityFilterSample/blob/main/Assets/ClusterScripts/Sample/bridge.js
...
事前にワールドやスクリプトの仕様のインプットがあれば、なんとなくやっていることが分かるかと思います。
...
このようにどこで何をやっているかがなんとなくわかれば、ちゃんと理解したほうが良い箇所とそれほど重要ではない箇所の整理ができるようになります。
...
先程の人狼ゲームを例に上げると、下記の仕様の数字の部分はカスタマイズできそうです。
...
このように、カスタマイズする場合はプレイ人数と人狼の人数のようなロジック的な不整合が潜んでいる場合があります。


# 解説してみる

すでに書かれているスクリプトの概要を読み解くことは、スクリプトを1から書くことよりも必要な知識が少なくて済みます。
...
スクリプトを書かないでも済む未来をつくるために一緒に頑張っていきましょう。
